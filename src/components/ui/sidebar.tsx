...
>(
  (
    ...
    return (
      <div
        ref={ref}
        className="group peer hidden xl:block text-sidebar-foreground"
        data-state={state}
      ...
      >
        ...
        <div
          className={cn(
            "duration-200 fixed inset-y-0 z-10 hidden h-svh w-[--sidebar-width] transition-[left,right,width] ease-linear xl:flex",
            side === "left"
        ...
        >
          <div
            data-sidebar="sidebar"
            className="flex h-full w-full flex-col bg-secondary/60 group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow"
          >
            {children}
          </div>
        </div>
